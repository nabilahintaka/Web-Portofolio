      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Hello Everyone, I am <span className="purple">Nabilah </span>
            ...
            <br />
            with internship experience as a UI/UX Designer Staff at Telkom Indonesia. 
            <br />
            <br />
          ...
          <ul>
            ...
            <li className="about-activity">
              <ImPointRight /> Staring at the ceilings with music on
            </li>
          </ul>
